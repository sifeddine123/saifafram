    ...
    function calculer(e) { 
     ...
     return (
        <form onSubmit={calculer}>
            ...
            + <input type="radio" name="op" value={'+'} onChange={(e) =>{setop(e.target.value)}}/>
            - <input type="radio" name="op" value={'-'} onChange={(e) =>{setop(e.target.value)}}/>
            x <input type="radio" name="op" value={'x'} onChange={(e) =>{setop(e.target.value)}}/>
            / <input type="radio" name="op" value={'op'} onChange={(e) =>{setop(e.target.value)}}/>
